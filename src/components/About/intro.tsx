...
const Intro = () => {
  return (
    <main className='mx-20 flex justify-start border-b-2 border-white pt-5'>
      ...
      <div className='ml-[80px] relative before:absolute before:w-[2px] before:h-[100%] before:top-0 before:l-0 before:bg-white'>
        <div  className='pl-7 pb-7'>
          ...
          <div className='w-full h-[500px] bg-yellow-400'>
            <ReactPlayer url='/image/vid4.mp4' playing={true} loop={true} controls width="100%" height="100%"/>
          </div>
        </div>
      </div>
    </main>
