  ...
  return (
    <main className="mt-8">
      <div className="border-2 border-white">
        ...
        <div className="m-6">
          <h2 className="font-normal text-normal text-center mb-6">
          ...
          <div className="flex justify-start">
            ...
            <form className="flex flex-col mt-0 w-full">
              ...
              <button
                type="submit"
                className="bg-white border-2 border-white text-black w-full text-center font-bold p-3 mt-4 text-medium hover:bg-black hover:text-white"
              >
                Submit
              </button>
            </form>
