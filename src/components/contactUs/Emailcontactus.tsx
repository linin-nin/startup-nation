      ...
      <div className="container flex">
        ...
        <div className=" w-[50%] p-8 text-white">
          <form className="flex flex-col mt-0 w-[100%] border-2 border-black p-8 ">
            <span className="font-normal text-medium mb-3 text-black">
              EMAIL
            </span>
            ...
            <button
              type="submit"
              className="bg-black border-2 border-white text-white   w-full text-center font-bold p-3 mt-4 text-medium"
            >
              Submit
            </button>
          </form>
