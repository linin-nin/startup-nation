      ...
      <div className='flex'>
        ...
        <div className='img-slide'>
          ...
          <ul className='ml-10 sm:ml-40 list-disc grid grid-cols-2 gap-x-4'>
            <li className="mt-5  text-[17px] md:text-[24px]">Provision of free working space</li>
            <li className="mt-5  text-[17px] md:text-[24px]">Meeting room, Event space and Play-ground</li>
            <li className="mt-5  text-[17px] md:text-[24px]">Training rooms and Studio room</li>
            <li className="mt-5  text-[17px] md:text-[24px]">Utility, Parking, and Security</li>
          </ul>
        </div>
        {/* arrow */}
